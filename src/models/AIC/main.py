...
data = SourceManager(loader).exec('../../../data/preprocessed')[3]
...
# X = training[['Interest_Rate','Unemployment_Rate']] # here we have 2 variables for the multiple linear regression.
